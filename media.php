...
$info = get_status_media($media_id);
...
if ($user['role'] != 'admin') {
    ...
    if ($user['id'] != $user_id) {
        ...
        set_flash_message("profile", "Вы можете редактировать только свой аватар!");
        header("Location: /users.php");
    }
    //echo "<br>вы редактируете cвой аккаунт!";
}
if ($info['avatar']) $_SESSION["avatar"] = true;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form enctype="multipart/form-data" action="edit_media.php" method="post">
        <div class="row">
            <div class="col-xl-6">
                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            <div class="form-group">
                                <?php if ($info['avatar']) { ?>
                                    <img src="img/demo/avatars/<?php echo $info['avatar']; ?>" alt=""
                                         class="img-responsive" width="200">
                                <?php } else { ?>
                                    <!-- если нет аватара,то отображается рисунок-заглушка -->
                                    <img src="img/demo/authors/noavatar.png" alt="" class="img-responsive" width="200">
                                <?php } ?>
                            </div>
                            ...
                            <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                <button type="submit" name="submit" class="btn btn-warning">Загрузить</button>
                            </div>
                        </div>
                    </div>
                </div>
